...
exports.storesCreateWithoutCategoriesInputObjectSchema = void 0;
...
const productsCreateNestedManyWithoutStoresInput_schema_1 = require("./productsCreateNestedManyWithoutStoresInput.schema");
...
const Schema = zod_1.z
    ...
    orders: zod_1.z
        ...
        .optional(),
    products: zod_1.z
        .lazy(() => productsCreateNestedManyWithoutStoresInput_schema_1.productsCreateNestedManyWithoutStoresInputObjectSchema)
        .optional(),
    sales: zod_1.z
    ...
    .strict();
exports.storesCreateWithoutCategoriesInputObjectSchema = Schema;
