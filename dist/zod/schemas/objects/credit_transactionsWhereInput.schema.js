...
exports.credit_transactionsWhereInputObjectSchema = void 0;
...
const Credit_accountsRelationFilter_schema_1 = require("./Credit_accountsRelationFilter.schema");
const credit_accountsWhereInput_schema_1 = require("./credit_accountsWhereInput.schema");
const Schema = zod_1.z
    .object({
    AND: zod_1.z
        .union([
        zod_1.z.lazy(() => exports.credit_transactionsWhereInputObjectSchema),
        zod_1.z.lazy(() => exports.credit_transactionsWhereInputObjectSchema).array(),
    ])
        .optional(),
    OR: zod_1.z
        .lazy(() => exports.credit_transactionsWhereInputObjectSchema)
        .array()
        .optional(),
    NOT: zod_1.z
        .union([
    ...
    credit_accounts: zod_1.z
        .union([
        zod_1.z.lazy(() => Credit_accountsRelationFilter_schema_1.Credit_accountsRelationFilterObjectSchema),
        zod_1.z.lazy(() => credit_accountsWhereInput_schema_1.credit_accountsWhereInputObjectSchema),
    ])
        .optional(),
})
    .strict();
exports.credit_transactionsWhereInputObjectSchema = Schema;
