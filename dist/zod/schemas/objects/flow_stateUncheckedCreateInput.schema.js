...
exports.flow_stateUncheckedCreateInputObjectSchema = void 0;
const zod_1 = require("zod");
const code_challenge_method_schema_1 = require("../enums/code_challenge_method.schema");
const saml_relay_statesUncheckedCreateNestedManyWithoutFlow_stateInput_schema_1 = require("./saml_relay_statesUncheckedCreateNestedManyWithoutFlow_stateInput.schema");
const Schema = zod_1.z
    ...
    saml_relay_states: zod_1.z
        .lazy(() => saml_relay_statesUncheckedCreateNestedManyWithoutFlow_stateInput_schema_1.saml_relay_statesUncheckedCreateNestedManyWithoutFlow_stateInputObjectSchema)
        .optional(),
})
    .strict();
exports.flow_stateUncheckedCreateInputObjectSchema = Schema;
