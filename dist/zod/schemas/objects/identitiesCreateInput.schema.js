...
exports.identitiesCreateInputObjectSchema = void 0;
const zod_1 = require("zod");
const JsonNullValueInput_schema_1 = require("../enums/JsonNullValueInput.schema");
const usersCreateNestedOneWithoutIdentitiesInput_schema_1 = require("./usersCreateNestedOneWithoutIdentitiesInput.schema");
...
const Schema = zod_1.z
    ...
    users: zod_1.z.lazy(() => usersCreateNestedOneWithoutIdentitiesInput_schema_1.usersCreateNestedOneWithoutIdentitiesInputObjectSchema),
})
    .strict();
exports.identitiesCreateInputObjectSchema = Schema;
