...
exports.DomainCreateNestedManyWithoutUserInputObjectSchema = void 0;
...
const Schema = zod_1.z
    ...
    create: zod_1.z
        ...
        zod_1.z.lazy(() => DomainUncheckedCreateWithoutUserInput_schema_1.DomainUncheckedCreateWithoutUserInputObjectSchema).array(),
    ])
        .optional(),
    connectOrCreate: zod_1.z
        .union([
        zod_1.z.lazy(() => DomainCreateOrConnectWithoutUserInput_schema_1.DomainCreateOrConnectWithoutUserInputObjectSchema),
        zod_1.z.lazy(() => DomainCreateOrConnectWithoutUserInput_schema_1.DomainCreateOrConnectWithoutUserInputObjectSchema).array(),
    ])
        .optional(),
    createMany: zod_1.z
    ...
    .strict();
exports.DomainCreateNestedManyWithoutUserInputObjectSchema = Schema;
