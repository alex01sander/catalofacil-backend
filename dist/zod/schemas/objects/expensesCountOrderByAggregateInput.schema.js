...
exports.expensesCountOrderByAggregateInputObjectSchema = void 0;
...
const Schema = zod_1.z
    ...
    due_date: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(),
    is_recurring: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(),
    recurring_frequency: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(),
    status: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(),
    paid_date: zod_1.z.lazy(() => SortOrder_schema_1.SortOrderSchema).optional(),
    ...
    .strict();
exports.expensesCountOrderByAggregateInputObjectSchema = Schema;
