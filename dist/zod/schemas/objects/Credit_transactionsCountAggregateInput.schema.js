...
exports.Credit_transactionsCountAggregateInputObjectSchema = void 0;
const zod_1 = require("zod");
const Schema = zod_1.z
    .object({
    id: zod_1.z.literal(true).optional(),
    credit_account_id: zod_1.z.literal(true).optional(),
    ...
    .strict();
exports.Credit_transactionsCountAggregateInputObjectSchema = Schema;
