...
exports.saml_providersCreateInputObjectSchema = void 0;
const zod_1 = require("zod");
const NullableJsonNullValueInput_schema_1 = require("../enums/NullableJsonNullValueInput.schema");
const sso_providersCreateNestedOneWithoutSaml_providersInput_schema_1 = require("./sso_providersCreateNestedOneWithoutSaml_providersInput.schema");
...
const Schema = zod_1.z
    ...
    sso_providers: zod_1.z.lazy(() => sso_providersCreateNestedOneWithoutSaml_providersInput_schema_1.sso_providersCreateNestedOneWithoutSaml_providersInputObjectSchema),
})
    .strict();
exports.saml_providersCreateInputObjectSchema = Schema;
