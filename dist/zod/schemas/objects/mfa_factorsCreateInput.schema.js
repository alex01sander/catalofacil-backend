...
exports.mfa_factorsCreateInputObjectSchema = void 0;
...
const mfa_challengesCreateNestedManyWithoutMfa_factorsInput_schema_1 = require("./mfa_challengesCreateNestedManyWithoutMfa_factorsInput.schema");
const usersCreateNestedOneWithoutMfa_factorsInput_schema_1 = require("./usersCreateNestedOneWithoutMfa_factorsInput.schema");
...
const Schema = zod_1.z
    ...
    mfa_challenges: zod_1.z
        .lazy(() => mfa_challengesCreateNestedManyWithoutMfa_factorsInput_schema_1.mfa_challengesCreateNestedManyWithoutMfa_factorsInputObjectSchema)
        .optional(),
    users: zod_1.z.lazy(() => usersCreateNestedOneWithoutMfa_factorsInput_schema_1.usersCreateNestedOneWithoutMfa_factorsInputObjectSchema),
})
    .strict();
exports.mfa_factorsCreateInputObjectSchema = Schema;
