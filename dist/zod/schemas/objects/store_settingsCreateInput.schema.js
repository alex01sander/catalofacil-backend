...
exports.store_settingsCreateInputObjectSchema = void 0;
const zod_1 = require("zod");
const usersCreateNestedOneWithoutStore_settingsInput_schema_1 = require("./usersCreateNestedOneWithoutStore_settingsInput.schema");
const Schema = zod_1.z
    ...
    users: zod_1.z.lazy(() => usersCreateNestedOneWithoutStore_settingsInput_schema_1.usersCreateNestedOneWithoutStore_settingsInputObjectSchema),
})
    .strict();
exports.store_settingsCreateInputObjectSchema = Schema;
