...
exports.Mfa_factorsCountAggregateInputObjectSchema = void 0;
...
const Schema = zod_1.z
    ...
    web_authn_credential: zod_1.z.literal(true).optional(),
    web_authn_aaguid: zod_1.z.literal(true).optional(),
    _all: zod_1.z.literal(true).optional(),
})
    .strict();
exports.Mfa_factorsCountAggregateInputObjectSchema = Schema;
