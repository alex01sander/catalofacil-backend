...
const Schema = zod_1.z
    .object({
    equals: zod_1.z
        .union([jsonSchema, zod_1.z.lazy(() => JsonNullValueFilter_schema_1.JsonNullValueFilterSchema)])
        .optional(),
    ...
    _min: zod_1.z.lazy(() => NestedJsonNullableFilter_schema_1.NestedJsonNullableFilterObjectSchema).optional(),
    _max: zod_1.z.lazy(() => NestedJsonNullableFilter_schema_1.NestedJsonNullableFilterObjectSchema).optional(),
})
    .strict();
exports.JsonNullableWithAggregatesFilterObjectSchema = Schema;
