...
exports.NestedUuidWithAggregatesFilterObjectSchema = void 0;
...
const Schema = zod_1.z
    ...
    not: zod_1.z
        .union([
        zod_1.z.string(),
        zod_1.z.lazy(() => exports.NestedUuidWithAggregatesFilterObjectSchema),
    ])
        .optional(),
    ...
    .strict();
exports.NestedUuidWithAggregatesFilterObjectSchema = Schema;
