...
describe('Zod Schemas', () => {
    describe('cashFlowCreateInputSchema', () => {
        it('should validate valid cash flow data', () => {
            ...
            const result = zod_1.cashFlowCreateInputSchema.safeParse(validData);
        ...
        it('should reject invalid type', () => {
            ...
            const result = zod_1.cashFlowCreateInputSchema.safeParse(invalidData);
    ...
    describe('credit_accountsCreateInputSchema', () => {
        it('should validate valid credit account data', () => {
            ...
            const result = zod_1.credit_accountsCreateInputSchema.safeParse(validData);
            expect(result.success).toBe(true);
        });
        ...
        it('should reject missing required fields', () => {
            ...
            const result = zod_1.credit_accountsCreateInputSchema.safeParse(invalidData);
            expect(result.success).toBe(false);
        });
    });
    describe('credit_transactionsCreateInputSchema', () => {
        it('should validate valid credit transaction data', () => {
            ...
            const result = zod_1.credit_transactionsCreateInputSchema.safeParse(validData);
            expect(result.success).toBe(true);
        });
        ...
        it('should reject invalid transaction type', () => {
            ...
            const result = zod_1.credit_transactionsCreateInputSchema.safeParse(invalidData);
            expect(result.success).toBe(false);
        });
    });
    describe('creditDebitWithInstallmentsSchema', () => {
        it('should validate valid debit with installments data', () => {
            ...
            const result = zod_1.creditDebitWithInstallmentsSchema.safeParse(validData);
            expect(result.success).toBe(true);
        });
        ...
        it('should reject invalid frequency', () => {
            ...
            const result = zod_1.creditDebitWithInstallmentsSchema.safeParse(invalidData);
            expect(result.success).toBe(false);
        });
