...
// ROTA GET PARA CRIAR USUÁRIO DIRETAMENTE NO INDEX
app.get('/criar-usuario', async (req: Request, res: Response) => {
  try {
...
app.use('/api/controller', controllerRouter); // Alias para compatibilidade com frontend
