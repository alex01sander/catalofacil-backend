...
const Schema: z.ZodType<Prisma.categoriesUncheckedCreateNestedManyWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
...
export const categoriesUncheckedCreateNestedManyWithoutUsersInputObjectSchema =
  Schema;
