...
const Schema: z.ZodType<Prisma.flow_stateUncheckedCreateWithoutSaml_relay_statesInput> =
  z
    .object({
      id: z.string(),
...
export const flow_stateUncheckedCreateWithoutSaml_relay_statesInputObjectSchema =
  Schema;
