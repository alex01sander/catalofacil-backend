...
const Schema: z.ZodType<Prisma.productsUpdateManyWithWhereWithoutUsersInput> = z
  .object({
...
export const productsUpdateManyWithWhereWithoutUsersInputObjectSchema = Schema;
