...
const Schema: z.ZodType<Prisma.ordersUncheckedCreateNestedManyWithoutCustomersInput> =
  z
    .object({
      create: z
        .union([
...
export const ordersUncheckedCreateNestedManyWithoutCustomersInputObjectSchema =
  Schema;
