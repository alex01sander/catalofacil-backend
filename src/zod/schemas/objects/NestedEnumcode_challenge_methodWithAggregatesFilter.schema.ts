...
const Schema: z.ZodType<Prisma.NestedEnumcode_challenge_methodWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumcode_challenge_methodWithAggregatesFilterObjectSchema =
  Schema;
