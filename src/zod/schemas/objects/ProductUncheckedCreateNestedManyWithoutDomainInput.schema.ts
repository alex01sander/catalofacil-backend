...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutDomainInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedCreateNestedManyWithoutDomainInputObjectSchema =
  Schema;
