...
const Schema: z.ZodType<Prisma.sso_domainsUpdateManyWithoutSso_providersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const sso_domainsUpdateManyWithoutSso_providersNestedInputObjectSchema =
  Schema;
