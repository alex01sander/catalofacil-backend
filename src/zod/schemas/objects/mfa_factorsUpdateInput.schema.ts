...
import { mfa_challengesUpdateManyWithoutMfa_factorsNestedInputObjectSchema } from './mfa_challengesUpdateManyWithoutMfa_factorsNestedInput.schema';
import { usersUpdateOneRequiredWithoutMfa_factorsNestedInputObjectSchema } from './usersUpdateOneRequiredWithoutMfa_factorsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.mfa_factorsUpdateInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    mfa_challenges: z
      .lazy(
        () => mfa_challengesUpdateManyWithoutMfa_factorsNestedInputObjectSchema,
      )
      .optional(),
    users: z
      .lazy(
        () => usersUpdateOneRequiredWithoutMfa_factorsNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const mfa_factorsUpdateInputObjectSchema = Schema;
