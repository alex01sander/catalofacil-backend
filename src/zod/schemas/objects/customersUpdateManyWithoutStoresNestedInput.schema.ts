...
const Schema: z.ZodType<Prisma.customersUpdateManyWithoutStoresNestedInput> = z
  .object({
    create: z
      .union([
...
export const customersUpdateManyWithoutStoresNestedInputObjectSchema = Schema;
