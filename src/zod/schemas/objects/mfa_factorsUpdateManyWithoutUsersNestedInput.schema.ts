...
const Schema: z.ZodType<Prisma.mfa_factorsUpdateManyWithoutUsersNestedInput> = z
  .object({
    create: z
      .union([
...
export const mfa_factorsUpdateManyWithoutUsersNestedInputObjectSchema = Schema;
