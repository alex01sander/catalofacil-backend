...
const Schema: z.ZodType<Prisma.NestedEnumone_time_token_typeWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumone_time_token_typeWithAggregatesFilterObjectSchema =
  Schema;
