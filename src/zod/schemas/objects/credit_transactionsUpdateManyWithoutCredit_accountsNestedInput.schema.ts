...
const Schema: z.ZodType<Prisma.credit_transactionsUpdateManyWithoutCredit_accountsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const credit_transactionsUpdateManyWithoutCredit_accountsNestedInputObjectSchema =
  Schema;
