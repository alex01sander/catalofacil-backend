...
const Schema: z.ZodType<Prisma.profilesUncheckedCreateNestedOneWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
...
export const profilesUncheckedCreateNestedOneWithoutUsersInputObjectSchema =
  Schema;
