...
const Schema: z.ZodType<Prisma.saml_relay_statesCountOrderByAggregateInput> = z
  .object({
...
export const saml_relay_statesCountOrderByAggregateInputObjectSchema = Schema;
