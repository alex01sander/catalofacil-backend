...
const Schema: z.ZodType<Prisma.refresh_tokensUpdateManyWithoutSessionsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const refresh_tokensUpdateManyWithoutSessionsNestedInputObjectSchema =
  Schema;
