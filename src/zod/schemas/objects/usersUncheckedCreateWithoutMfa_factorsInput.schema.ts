...
const Schema: z.ZodType<Prisma.usersUncheckedCreateWithoutMfa_factorsInput> = z
  .object({
...
export const usersUncheckedCreateWithoutMfa_factorsInputObjectSchema = Schema;
