...
const Schema: z.ZodType<Prisma.productsUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => productsUpdateManyWithWhereWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () => productsUpdateManyWithWhereWithoutUsersInputObjectSchema,
...
export const productsUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
