...
import { categoriesUncheckedUpdateManyWithoutStoresNestedInputObjectSchema } from './categoriesUncheckedUpdateManyWithoutStoresNestedInput.schema';
...
const Schema: z.ZodType<Prisma.storesUncheckedUpdateWithoutCustomersInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    categories: z
      .lazy(
        () => categoriesUncheckedUpdateManyWithoutStoresNestedInputObjectSchema,
      )
      .optional(),
    orders: z
...
export const storesUncheckedUpdateWithoutCustomersInputObjectSchema = Schema;
