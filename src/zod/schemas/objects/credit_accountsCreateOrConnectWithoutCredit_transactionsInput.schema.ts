...
const Schema: z.ZodType<Prisma.credit_accountsCreateOrConnectWithoutCredit_transactionsInput> =
  z
    .object({
      where: z.lazy(() => credit_accountsWhereUniqueInputObjectSchema),
      create: z.union([
        z.lazy(
          () =>
...
export const credit_accountsCreateOrConnectWithoutCredit_transactionsInputObjectSchema =
  Schema;
