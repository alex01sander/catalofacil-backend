...
const Schema: z.ZodType<Prisma.saml_relay_statesUncheckedUpdateManyWithoutSso_providersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const saml_relay_statesUncheckedUpdateManyWithoutSso_providersNestedInputObjectSchema =
  Schema;
