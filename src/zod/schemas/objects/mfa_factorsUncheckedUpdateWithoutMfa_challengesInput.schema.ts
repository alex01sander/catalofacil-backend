...
const Schema: z.ZodType<Prisma.mfa_factorsUncheckedUpdateWithoutMfa_challengesInput> =
  z
    .object({
      id: z
        .union([
...
export const mfa_factorsUncheckedUpdateWithoutMfa_challengesInputObjectSchema =
  Schema;
