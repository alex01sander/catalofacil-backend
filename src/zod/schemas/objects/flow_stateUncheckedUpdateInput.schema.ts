...
import { saml_relay_statesUncheckedUpdateManyWithoutFlow_stateNestedInputObjectSchema } from './saml_relay_statesUncheckedUpdateManyWithoutFlow_stateNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.flow_stateUncheckedUpdateInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    saml_relay_states: z
      .lazy(
        () =>
          saml_relay_statesUncheckedUpdateManyWithoutFlow_stateNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const flow_stateUncheckedUpdateInputObjectSchema = Schema;
