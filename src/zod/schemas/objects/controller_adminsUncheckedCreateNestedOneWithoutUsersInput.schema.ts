...
const Schema: z.ZodType<Prisma.controller_adminsUncheckedCreateNestedOneWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
...
export const controller_adminsUncheckedCreateNestedOneWithoutUsersInputObjectSchema =
  Schema;
