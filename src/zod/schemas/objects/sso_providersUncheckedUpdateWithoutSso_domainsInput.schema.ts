...
const Schema: z.ZodType<Prisma.sso_providersUncheckedUpdateWithoutSso_domainsInput> =
  z
    .object({
      id: z
        .union([
...
export const sso_providersUncheckedUpdateWithoutSso_domainsInputObjectSchema =
  Schema;
