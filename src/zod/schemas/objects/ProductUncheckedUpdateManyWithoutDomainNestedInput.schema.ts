...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutDomainNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ProductUpdateManyWithWhereWithoutDomainInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductUpdateManyWithWhereWithoutDomainInputObjectSchema,
...
export const ProductUncheckedUpdateManyWithoutDomainNestedInputObjectSchema =
  Schema;
