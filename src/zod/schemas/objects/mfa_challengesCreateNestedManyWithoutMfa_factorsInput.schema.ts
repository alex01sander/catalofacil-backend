...
const Schema: z.ZodType<Prisma.mfa_challengesCreateNestedManyWithoutMfa_factorsInput> =
  z
    .object({
      create: z
        .union([
...
export const mfa_challengesCreateNestedManyWithoutMfa_factorsInputObjectSchema =
  Schema;
