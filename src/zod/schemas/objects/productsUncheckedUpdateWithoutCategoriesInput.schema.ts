...
const Schema: z.ZodType<Prisma.productsUncheckedUpdateWithoutCategoriesInput> =
  z
    .object({
      id: z
        .union([
...
export const productsUncheckedUpdateWithoutCategoriesInputObjectSchema = Schema;
