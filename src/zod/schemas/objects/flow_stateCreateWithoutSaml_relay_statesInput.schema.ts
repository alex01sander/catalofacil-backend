...
const Schema: z.ZodType<Prisma.flow_stateCreateWithoutSaml_relay_statesInput> =
  z
    .object({
      id: z.string(),
...
export const flow_stateCreateWithoutSaml_relay_statesInputObjectSchema = Schema;
