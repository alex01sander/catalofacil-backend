...
const Schema: z.ZodType<Prisma.Saml_providersCountAggregateInputType> = z
  .object({
    ...
    attribute_mapping: z.literal(true).optional(),
...
export const Saml_providersCountAggregateInputObjectSchema = Schema;
