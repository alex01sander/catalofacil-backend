...
const Schema: z.ZodType<Prisma.one_time_tokensCreateNestedManyWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
...
export const one_time_tokensCreateNestedManyWithoutUsersInputObjectSchema =
  Schema;
