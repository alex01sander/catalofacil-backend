...
const Schema: z.ZodType<Prisma.usersUncheckedUpdateWithoutController_adminsInput> =
  z
    .object({
      instance_id: z
        .union([
...
export const usersUncheckedUpdateWithoutController_adminsInputObjectSchema =
  Schema;
