...
const Schema: z.ZodType<Prisma.storesUncheckedCreateWithoutCategoriesInput> = z
  .object({
...
export const storesUncheckedCreateWithoutCategoriesInputObjectSchema = Schema;
