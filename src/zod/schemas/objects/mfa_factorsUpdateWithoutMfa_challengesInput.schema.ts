...
const Schema: z.ZodType<Prisma.mfa_factorsUpdateWithoutMfa_challengesInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const mfa_factorsUpdateWithoutMfa_challengesInputObjectSchema = Schema;
