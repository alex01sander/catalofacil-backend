...
const Schema: z.ZodType<Prisma.salesUncheckedUpdateManyWithoutStoresNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => salesUpsertWithWhereUniqueWithoutStoresInputObjectSchema,
          ),
          z
            .lazy(
              () => salesUpsertWithWhereUniqueWithoutStoresInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => salesUpdateWithWhereUniqueWithoutStoresInputObjectSchema,
          ),
          z
            .lazy(
              () => salesUpdateWithWhereUniqueWithoutStoresInputObjectSchema,
...
export const salesUncheckedUpdateManyWithoutStoresNestedInputObjectSchema =
  Schema;
