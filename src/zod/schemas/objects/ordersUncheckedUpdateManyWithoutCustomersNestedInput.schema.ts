...
const Schema: z.ZodType<Prisma.ordersUncheckedUpdateManyWithoutCustomersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ordersUncheckedUpdateManyWithoutCustomersNestedInputObjectSchema =
  Schema;
