...
const Schema: z.ZodType<Prisma.storesUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => storesUpsertWithWhereUniqueWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () => storesUpsertWithWhereUniqueWithoutUsersInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => storesUpdateWithWhereUniqueWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () => storesUpdateWithWhereUniqueWithoutUsersInputObjectSchema,
...
export const storesUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
