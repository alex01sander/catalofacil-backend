...
const Schema: z.ZodType<Prisma.productsUncheckedUpdateManyWithoutCategoriesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const productsUncheckedUpdateManyWithoutCategoriesNestedInputObjectSchema =
  Schema;
