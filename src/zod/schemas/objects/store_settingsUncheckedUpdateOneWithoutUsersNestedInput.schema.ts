...
const Schema: z.ZodType<Prisma.store_settingsUncheckedUpdateOneWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const store_settingsUncheckedUpdateOneWithoutUsersNestedInputObjectSchema =
  Schema;
