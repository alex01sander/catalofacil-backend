...
const Schema: z.ZodType<Prisma.ordersUncheckedUpdateManyWithoutStoresNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ordersUpsertWithWhereUniqueWithoutStoresInputObjectSchema,
          ),
          z
            .lazy(
              () => ordersUpsertWithWhereUniqueWithoutStoresInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ordersUpdateWithWhereUniqueWithoutStoresInputObjectSchema,
          ),
          z
            .lazy(
              () => ordersUpdateWithWhereUniqueWithoutStoresInputObjectSchema,
...
export const ordersUncheckedUpdateManyWithoutStoresNestedInputObjectSchema =
  Schema;
