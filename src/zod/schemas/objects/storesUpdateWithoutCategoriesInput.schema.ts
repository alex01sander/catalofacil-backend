...
import { productsUpdateManyWithoutStoresNestedInputObjectSchema } from './productsUpdateManyWithoutStoresNestedInput.schema';
...
const Schema: z.ZodType<Prisma.storesUpdateWithoutCategoriesInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    orders: z
      ...
      .optional(),
    products: z
      .lazy(() => productsUpdateManyWithoutStoresNestedInputObjectSchema)
      .optional(),
    sales: z
...
export const storesUpdateWithoutCategoriesInputObjectSchema = Schema;
