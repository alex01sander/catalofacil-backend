...
const Schema: z.ZodType<Prisma.mfa_challengesUncheckedUpdateManyWithoutMfa_factorsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const mfa_challengesUncheckedUpdateManyWithoutMfa_factorsNestedInputObjectSchema =
  Schema;
