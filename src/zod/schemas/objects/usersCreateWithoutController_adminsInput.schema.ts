...
import { customersCreateNestedManyWithoutUsersInputObjectSchema } from './customersCreateNestedManyWithoutUsersInput.schema';
...
const Schema: z.ZodType<Prisma.usersCreateWithoutController_adminsInput> = z
  .object({
    ...
    categories: z
      ...
      .optional(),
    customers: z
      .lazy(() => customersCreateNestedManyWithoutUsersInputObjectSchema)
      .optional(),
    domain_owners: z
...
export const usersCreateWithoutController_adminsInputObjectSchema = Schema;
