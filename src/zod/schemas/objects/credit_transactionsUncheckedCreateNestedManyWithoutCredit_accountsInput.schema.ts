...
const Schema: z.ZodType<Prisma.credit_transactionsUncheckedCreateNestedManyWithoutCredit_accountsInput> =
  z
    .object({
      create: z
        .union([
...
export const credit_transactionsUncheckedCreateNestedManyWithoutCredit_accountsInputObjectSchema =
  Schema;
