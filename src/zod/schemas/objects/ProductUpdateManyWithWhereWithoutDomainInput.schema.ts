...
const Schema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutDomainInput> = z
  .object({
...
export const ProductUpdateManyWithWhereWithoutDomainInputObjectSchema = Schema;
