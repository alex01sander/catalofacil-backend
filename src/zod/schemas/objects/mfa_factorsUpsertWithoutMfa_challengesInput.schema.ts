...
const Schema: z.ZodType<Prisma.mfa_factorsUpsertWithoutMfa_challengesInput> = z
  .object({
    update: z.union([
...
export const mfa_factorsUpsertWithoutMfa_challengesInputObjectSchema = Schema;
