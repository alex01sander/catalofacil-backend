...
const Schema: z.ZodType<Prisma.saml_relay_statesUpdateManyWithWhereWithoutSso_providersInput> =
  z
    .object({
...
export const saml_relay_statesUpdateManyWithWhereWithoutSso_providersInputObjectSchema =
  Schema;
