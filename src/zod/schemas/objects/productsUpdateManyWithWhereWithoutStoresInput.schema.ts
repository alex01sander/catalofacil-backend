...
const Schema: z.ZodType<Prisma.productsUpdateManyWithWhereWithoutStoresInput> =
  z
    .object({
...
export const productsUpdateManyWithWhereWithoutStoresInputObjectSchema = Schema;
