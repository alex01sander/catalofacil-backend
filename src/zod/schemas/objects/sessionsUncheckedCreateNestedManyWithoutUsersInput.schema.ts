...
const Schema: z.ZodType<Prisma.sessionsUncheckedCreateNestedManyWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
...
export const sessionsUncheckedCreateNestedManyWithoutUsersInputObjectSchema =
  Schema;
