...
const Schema: z.ZodType<Prisma.ordersUncheckedCreateNestedManyWithoutStoresInput> =
  z
    .object({
      create: z
        .union([
...
export const ordersUncheckedCreateNestedManyWithoutStoresInputObjectSchema =
  Schema;
