...
const Schema: z.ZodType<Prisma.controller_adminsUncheckedUpdateOneWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const controller_adminsUncheckedUpdateOneWithoutUsersNestedInputObjectSchema =
  Schema;
