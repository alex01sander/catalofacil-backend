...
const Schema: z.ZodType<Prisma.saml_providersUncheckedCreateNestedManyWithoutSso_providersInput> =
  z
    .object({
      create: z
        .union([
...
export const saml_providersUncheckedCreateNestedManyWithoutSso_providersInputObjectSchema =
  Schema;
