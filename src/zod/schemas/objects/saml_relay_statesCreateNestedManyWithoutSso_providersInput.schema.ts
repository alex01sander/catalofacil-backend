...
const Schema: z.ZodType<Prisma.saml_relay_statesCreateNestedManyWithoutSso_providersInput> =
  z
    .object({
      create: z
        .union([
...
export const saml_relay_statesCreateNestedManyWithoutSso_providersInputObjectSchema =
  Schema;
