import { z } from 'zod';
import { customersCreateNestedManyWithoutStoresInputObjectSchema } from './customersCreateNestedManyWithoutStoresInput.schema';
...
const Schema: z.ZodType<Prisma.storesCreateWithoutCategoriesInput> = z
  .object({
    ...
    customers: z
      .lazy(() => customersCreateNestedManyWithoutStoresInputObjectSchema)
      .optional(),
    orders: z
...
export const storesCreateWithoutCategoriesInputObjectSchema = Schema;
