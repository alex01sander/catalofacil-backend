...
const Schema: z.ZodType<Prisma.order_itemsUncheckedCreateNestedManyWithoutOrdersInput> =
  z
    .object({
      create: z
        .union([
...
export const order_itemsUncheckedCreateNestedManyWithoutOrdersInputObjectSchema =
  Schema;
