...
const Schema: z.ZodType<Prisma.saml_providersUncheckedUpdateManyWithoutSso_providersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const saml_providersUncheckedUpdateManyWithoutSso_providersNestedInputObjectSchema =
  Schema;
