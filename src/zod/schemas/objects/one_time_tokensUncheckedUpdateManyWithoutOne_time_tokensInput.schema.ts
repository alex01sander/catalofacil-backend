...
const Schema: z.ZodType<Prisma.one_time_tokensUncheckedUpdateManyWithoutOne_time_tokensInput> =
  z
    .object({
      id: z
        .union([
...
export const one_time_tokensUncheckedUpdateManyWithoutOne_time_tokensInputObjectSchema =
  Schema;
