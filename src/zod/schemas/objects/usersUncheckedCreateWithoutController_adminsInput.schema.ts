...
import { productsUncheckedCreateNestedManyWithoutUsersInputObjectSchema } from './productsUncheckedCreateNestedManyWithoutUsersInput.schema';
...
const Schema: z.ZodType<Prisma.usersUncheckedCreateWithoutController_adminsInput> =
  z
    .object({
      ...
      orders: z
        .lazy(
          () => ordersUncheckedCreateNestedManyWithoutUsersInputObjectSchema,
        )
        .optional(),
      products: z
        .lazy(
          () => productsUncheckedCreateNestedManyWithoutUsersInputObjectSchema,
        )
        .optional(),
      profiles: z
        .lazy(
          () => profilesUncheckedCreateNestedOneWithoutUsersInputObjectSchema,
        )
        .optional(),
      store_settings: z
        .lazy(
      ...
      stores: z
        .lazy(
          () => storesUncheckedCreateNestedManyWithoutUsersInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const usersUncheckedCreateWithoutController_adminsInputObjectSchema =
  Schema;
