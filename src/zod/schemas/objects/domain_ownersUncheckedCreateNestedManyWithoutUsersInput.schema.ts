...
const Schema: z.ZodType<Prisma.domain_ownersUncheckedCreateNestedManyWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
...
export const domain_ownersUncheckedCreateNestedManyWithoutUsersInputObjectSchema =
  Schema;
