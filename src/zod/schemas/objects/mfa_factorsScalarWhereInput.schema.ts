...
const Schema: z.ZodType<Prisma.mfa_factorsScalarWhereInput> = z
  .object({
    AND: z
      .union([
      ...
      .optional(),
    OR: z
      .lazy(() => mfa_factorsScalarWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const mfa_factorsScalarWhereInputObjectSchema = Schema;
