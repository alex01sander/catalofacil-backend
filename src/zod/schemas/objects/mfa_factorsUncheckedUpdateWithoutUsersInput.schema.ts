...
import { mfa_challengesUncheckedUpdateManyWithoutMfa_factorsNestedInputObjectSchema } from './mfa_challengesUncheckedUpdateManyWithoutMfa_factorsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.mfa_factorsUncheckedUpdateWithoutUsersInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    mfa_challenges: z
      .lazy(
        () =>
          mfa_challengesUncheckedUpdateManyWithoutMfa_factorsNestedInputObjectSchema,
      )
      .optional(),
  })
  .strict();

export const mfa_factorsUncheckedUpdateWithoutUsersInputObjectSchema = Schema;
