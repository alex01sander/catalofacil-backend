...
const Schema: z.ZodType<Prisma.saml_relay_statesCreateNestedManyWithoutFlow_stateInput> =
  z
    .object({
      create: z
        .union([
...
export const saml_relay_statesCreateNestedManyWithoutFlow_stateInputObjectSchema =
  Schema;
