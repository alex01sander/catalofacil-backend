...
const Schema: z.ZodType<Prisma.productsUncheckedCreateNestedManyWithoutStoresInput> =
  z
    .object({
      create: z
        .union([
...
export const productsUncheckedCreateNestedManyWithoutStoresInputObjectSchema =
  Schema;
