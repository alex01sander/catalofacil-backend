...
const Schema: z.ZodType<Prisma.saml_relay_statesCreateOrConnectWithoutSso_providersInput> =
  z
    .object({
...
export const saml_relay_statesCreateOrConnectWithoutSso_providersInputObjectSchema =
  Schema;
