...
const Schema: z.ZodType<Prisma.domain_ownersUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const domain_ownersUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
