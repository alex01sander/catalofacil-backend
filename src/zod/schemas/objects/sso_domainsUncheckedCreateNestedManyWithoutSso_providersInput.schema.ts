...
const Schema: z.ZodType<Prisma.sso_domainsUncheckedCreateNestedManyWithoutSso_providersInput> =
  z
    .object({
      create: z
        .union([
...
export const sso_domainsUncheckedCreateNestedManyWithoutSso_providersInputObjectSchema =
  Schema;
