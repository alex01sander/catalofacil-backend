...
const Schema: z.ZodType<Prisma.identitiesUncheckedCreateNestedManyWithoutUsersInput> =
  z
    .object({
      create: z
        .union([
...
export const identitiesUncheckedCreateNestedManyWithoutUsersInputObjectSchema =
  Schema;
