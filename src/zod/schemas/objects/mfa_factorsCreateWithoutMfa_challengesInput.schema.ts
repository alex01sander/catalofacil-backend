...
import { usersCreateNestedOneWithoutMfa_factorsInputObjectSchema } from './usersCreateNestedOneWithoutMfa_factorsInput.schema';
...
const Schema: z.ZodType<Prisma.mfa_factorsCreateWithoutMfa_challengesInput> = z
  .object({
    id: z.string(),
    ...
    users: z.lazy(
      () => usersCreateNestedOneWithoutMfa_factorsInputObjectSchema,
    ),
  })
  .strict();

export const mfa_factorsCreateWithoutMfa_challengesInputObjectSchema = Schema;
