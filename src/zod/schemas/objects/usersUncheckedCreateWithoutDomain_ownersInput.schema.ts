...
const Schema: z.ZodType<Prisma.usersUncheckedCreateWithoutDomain_ownersInput> =
  z
    .object({
...
export const usersUncheckedCreateWithoutDomain_ownersInputObjectSchema = Schema;
