...
const Schema: z.ZodType<Prisma.mfa_factorsUncheckedUpdateManyWithoutMfa_factorsInput> =
  z
    .object({
      id: z
        .union([
...
export const mfa_factorsUncheckedUpdateManyWithoutMfa_factorsInputObjectSchema =
  Schema;
