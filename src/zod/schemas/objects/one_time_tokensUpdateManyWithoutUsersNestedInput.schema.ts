...
const Schema: z.ZodType<Prisma.one_time_tokensUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const one_time_tokensUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
