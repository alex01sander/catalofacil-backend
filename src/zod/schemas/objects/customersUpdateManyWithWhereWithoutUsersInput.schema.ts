...
const Schema: z.ZodType<Prisma.customersUpdateManyWithWhereWithoutUsersInput> =
  z
    .object({
...
export const customersUpdateManyWithWhereWithoutUsersInputObjectSchema = Schema;
