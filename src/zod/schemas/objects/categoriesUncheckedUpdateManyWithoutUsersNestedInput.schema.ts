...
const Schema: z.ZodType<Prisma.categoriesUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const categoriesUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
