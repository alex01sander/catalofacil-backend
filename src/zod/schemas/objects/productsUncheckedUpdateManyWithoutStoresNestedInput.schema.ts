...
const Schema: z.ZodType<Prisma.productsUncheckedUpdateManyWithoutStoresNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => productsUpdateManyWithWhereWithoutStoresInputObjectSchema,
          ),
          z
            .lazy(
              () => productsUpdateManyWithWhereWithoutStoresInputObjectSchema,
...
export const productsUncheckedUpdateManyWithoutStoresNestedInputObjectSchema =
  Schema;
