...
import { domain_ownersUncheckedUpdateManyWithoutUsersNestedInputObjectSchema } from './domain_ownersUncheckedUpdateManyWithoutUsersNestedInput.schema';
...
const Schema: z.ZodType<Prisma.usersUncheckedUpdateWithoutMfa_factorsInput> = z
  .object({
    instance_id: z
      .union([
        z.string(),
    ...
    domain_owners: z
      .lazy(
        () =>
          domain_ownersUncheckedUpdateManyWithoutUsersNestedInputObjectSchema,
      )
      .optional(),
    orders: z
      .lazy(() => ordersUncheckedUpdateManyWithoutUsersNestedInputObjectSchema)
      .optional(),
    products: z
      .lazy(
      ...
      .optional(),
    profiles: z
      .lazy(() => profilesUncheckedUpdateOneWithoutUsersNestedInputObjectSchema)
      .optional(),
    store_settings: z
      .lazy(
        () =>
      ...
      .optional(),
    stores: z
      .lazy(() => storesUncheckedUpdateManyWithoutUsersNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const usersUncheckedUpdateWithoutMfa_factorsInputObjectSchema = Schema;
