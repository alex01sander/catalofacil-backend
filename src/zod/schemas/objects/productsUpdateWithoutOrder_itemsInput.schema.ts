...
import { categoriesUpdateOneWithoutProductsNestedInputObjectSchema } from './categoriesUpdateOneWithoutProductsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.productsUpdateWithoutOrder_itemsInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    updated_at: z
      ...
      .nullable(),
    categories: z
      .lazy(() => categoriesUpdateOneWithoutProductsNestedInputObjectSchema)
      .optional(),
    stores: z
...
export const productsUpdateWithoutOrder_itemsInputObjectSchema = Schema;
