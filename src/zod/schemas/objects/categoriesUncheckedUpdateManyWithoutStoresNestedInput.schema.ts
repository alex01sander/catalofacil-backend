...
const Schema: z.ZodType<Prisma.categoriesUncheckedUpdateManyWithoutStoresNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const categoriesUncheckedUpdateManyWithoutStoresNestedInputObjectSchema =
  Schema;
