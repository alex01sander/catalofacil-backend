...
const Schema: z.ZodType<Prisma.productsUncheckedCreateWithoutCategoriesInput> =
  z
    .object({
...
export const productsUncheckedCreateWithoutCategoriesInputObjectSchema = Schema;
