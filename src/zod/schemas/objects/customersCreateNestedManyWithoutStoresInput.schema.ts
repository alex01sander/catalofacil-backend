...
const Schema: z.ZodType<Prisma.customersCreateNestedManyWithoutStoresInput> = z
  .object({
    create: z
      .union([
...
export const customersCreateNestedManyWithoutStoresInputObjectSchema = Schema;
