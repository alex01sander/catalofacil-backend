...
const Schema: z.ZodType<Prisma.refresh_tokensCreateNestedManyWithoutSessionsInput> =
  z
    .object({
      create: z
        .union([
...
export const refresh_tokensCreateNestedManyWithoutSessionsInputObjectSchema =
  Schema;
