...
const Schema: z.ZodType<Prisma.identitiesUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const identitiesUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
