...
const Schema: z.ZodType<Prisma.ordersUncheckedUpdateManyWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ordersUpsertWithWhereUniqueWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () => ordersUpsertWithWhereUniqueWithoutUsersInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ordersUpdateWithWhereUniqueWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () => ordersUpdateWithWhereUniqueWithoutUsersInputObjectSchema,
...
export const ordersUncheckedUpdateManyWithoutUsersNestedInputObjectSchema =
  Schema;
