...
const Schema: z.ZodType<Prisma.order_itemsUpdateManyWithoutOrdersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const order_itemsUpdateManyWithoutOrdersNestedInputObjectSchema = Schema;
