...
const Schema: z.ZodType<Prisma.categoriesUncheckedCreateNestedManyWithoutStoresInput> =
  z
    .object({
      create: z
        .union([
...
export const categoriesUncheckedCreateNestedManyWithoutStoresInputObjectSchema =
  Schema;
