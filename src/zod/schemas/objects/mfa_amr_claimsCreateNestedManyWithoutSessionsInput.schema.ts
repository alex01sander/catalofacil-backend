...
const Schema: z.ZodType<Prisma.mfa_amr_claimsCreateNestedManyWithoutSessionsInput> =
  z
    .object({
      create: z
        .union([
...
export const mfa_amr_claimsCreateNestedManyWithoutSessionsInputObjectSchema =
  Schema;
