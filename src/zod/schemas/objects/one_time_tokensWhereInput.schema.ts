...
const Schema: z.ZodType<Prisma.one_time_tokensWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => one_time_tokensWhereInputObjectSchema),
        z.lazy(() => one_time_tokensWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => one_time_tokensWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const one_time_tokensWhereInputObjectSchema = Schema;
