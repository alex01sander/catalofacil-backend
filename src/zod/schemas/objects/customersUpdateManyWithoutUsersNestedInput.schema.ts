...
const Schema: z.ZodType<Prisma.customersUpdateManyWithoutUsersNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => customersUpdateManyWithWhereWithoutUsersInputObjectSchema),
        z
          .lazy(() => customersUpdateManyWithWhereWithoutUsersInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const customersUpdateManyWithoutUsersNestedInputObjectSchema = Schema;
