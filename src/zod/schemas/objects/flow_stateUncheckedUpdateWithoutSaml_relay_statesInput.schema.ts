...
const Schema: z.ZodType<Prisma.flow_stateUncheckedUpdateWithoutSaml_relay_statesInput> =
  z
    .object({
      id: z
        .union([
...
export const flow_stateUncheckedUpdateWithoutSaml_relay_statesInputObjectSchema =
  Schema;
