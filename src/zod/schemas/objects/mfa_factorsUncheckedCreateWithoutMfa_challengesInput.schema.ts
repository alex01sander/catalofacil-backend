...
const Schema: z.ZodType<Prisma.mfa_factorsUncheckedCreateWithoutMfa_challengesInput> =
  z
    .object({
      id: z.string(),
      user_id: z.string(),
...
export const mfa_factorsUncheckedCreateWithoutMfa_challengesInputObjectSchema =
  Schema;
