...
const Schema: z.ZodType<Prisma.sessionsUpdateManyWithoutUsersNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => sessionsUpdateManyWithWhereWithoutUsersInputObjectSchema),
        z
          .lazy(() => sessionsUpdateManyWithWhereWithoutUsersInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const sessionsUpdateManyWithoutUsersNestedInputObjectSchema = Schema;
