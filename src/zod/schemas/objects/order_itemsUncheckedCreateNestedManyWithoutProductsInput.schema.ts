...
const Schema: z.ZodType<Prisma.order_itemsUncheckedCreateNestedManyWithoutProductsInput> =
  z
    .object({
      create: z
        .union([
...
export const order_itemsUncheckedCreateNestedManyWithoutProductsInputObjectSchema =
  Schema;
