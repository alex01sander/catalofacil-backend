...
const Schema: z.ZodType<Prisma.saml_relay_statesUncheckedUpdateManyWithoutFlow_stateNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const saml_relay_statesUncheckedUpdateManyWithoutFlow_stateNestedInputObjectSchema =
  Schema;
