...
const Schema: z.ZodType<Prisma.NestedEnumfactor_statusWithAggregatesFilter> = z
  .object({
...
export const NestedEnumfactor_statusWithAggregatesFilterObjectSchema = Schema;
