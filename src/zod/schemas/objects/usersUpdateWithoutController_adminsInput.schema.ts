...
import { customersUpdateManyWithoutUsersNestedInputObjectSchema } from './customersUpdateManyWithoutUsersNestedInput.schema';
...
const Schema: z.ZodType<Prisma.usersUpdateWithoutController_adminsInput> = z
  .object({
    instance_id: z
      .union([
        z.string(),
    ...
    categories: z
      ...
      .optional(),
    customers: z
      .lazy(() => customersUpdateManyWithoutUsersNestedInputObjectSchema)
      .optional(),
    domain_owners: z
...
export const usersUpdateWithoutController_adminsInputObjectSchema = Schema;
