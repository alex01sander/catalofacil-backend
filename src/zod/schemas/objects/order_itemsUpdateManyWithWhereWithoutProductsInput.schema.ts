...
const Schema: z.ZodType<Prisma.order_itemsUpdateManyWithWhereWithoutProductsInput> =
  z
    .object({
...
export const order_itemsUpdateManyWithWhereWithoutProductsInputObjectSchema =
  Schema;
