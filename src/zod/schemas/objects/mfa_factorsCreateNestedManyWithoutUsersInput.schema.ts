...
const Schema: z.ZodType<Prisma.mfa_factorsCreateNestedManyWithoutUsersInput> = z
  .object({
    create: z
      .union([
...
export const mfa_factorsCreateNestedManyWithoutUsersInputObjectSchema = Schema;
