...
const Schema: z.ZodType<Prisma.mfa_amr_claimsUncheckedUpdateManyWithoutSessionsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const mfa_amr_claimsUncheckedUpdateManyWithoutSessionsNestedInputObjectSchema =
  Schema;
