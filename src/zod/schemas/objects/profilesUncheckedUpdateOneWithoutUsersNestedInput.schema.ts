...
const Schema: z.ZodType<Prisma.profilesUncheckedUpdateOneWithoutUsersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const profilesUncheckedUpdateOneWithoutUsersNestedInputObjectSchema =
  Schema;
